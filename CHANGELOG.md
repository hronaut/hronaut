...
- Treat Linux autostart entries with any duplicate Desktop Entry key as invalid instead of reporting an ambiguous launch-at-sign-in registration as enabled.
