...
- Create a fresh scratch workspace for each task with `browser_workspaces`. Use only your task workspace.
...
- They do not authorize access to another task's workspace, or an everyday browser profile.
