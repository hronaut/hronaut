...
| Header alignment | The rail counted its divider inside the header while navigation added a border below it, producing a one-pixel step. | Paint both column dividers inside the same header height with matching thickness and color; check page and Home headers at 100%, 110%, and 125% scale. |
