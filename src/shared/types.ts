...
export interface HronautApi {
  ...
  openWorkspaceTemplateFile(): Promise<string | null>
  saveWorkspaceTemplateFile(reviewedText: string): Promise<boolean>
  ...
  changeHumanWaiting(workspaceId: string, id: string, revision: string, action: 'acknowledge' | 'cancel' | 'reject' | 'resolve', confirmation?: import('./human-waiting.js').HumanWaitingTrustedConfirmation): Promise<import('./human-waiting.js').HumanWaitingRecord>
