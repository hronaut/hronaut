...
export interface HronautApi {
  ...
  changeHumanWaiting(workspaceId: string, id: string, revision: string, action: 'acknowledge' | 'cancel' | 'reject' | 'resolve'): Promise<import('./human-waiting.js').HumanWaitingRecord>
