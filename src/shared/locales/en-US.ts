export const enUS = {
  ...
  wallets: {
    ...
    mainnetWarning: 'Mainnet uses real funds. Every signing or sending request still requires trusted human approval.',
    ...
    dedicatedAgentDescription: 'This wallet is explicitly designated for agent-requested operations. It still follows workspace permissions, simulation, policy limits, and trusted approval; mainnet always requires you.',
    ...
    boundedHeading: 'Bounded testnet/local automation',
    boundedDescription: 'Mainnet signing always asks. Unknown actions, unlimited approvals, new programs/contracts, blind messages, and failed simulations always ask.',
  ...
  runtime: {
    ...
    locks: { websiteOnly: 'Tab lock is available on websites', allLocked: 'All tabs locked — page input and tab closing are blocked', unlockTab: 'Unlock page input in this tab', lockTab: 'Lock page input in this tab', unlockAll: 'Unlock all tabs', lockAll: 'Lock all tabs — blocks page input and tab closing; tab switching and Hronaut controls stay available', unlockToClose: 'Unlock all tabs to close this tab', closeShortcut: 'Close tab (Ctrl/Cmd+W)', closeUnavailable: 'Close tab unavailable while all tabs are locked', inputLocked: 'Page input is locked', inputLock: 'Page input lock' },
