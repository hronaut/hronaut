export const enUS = {
  ...
  settings: {
    ...
    privacy: { heading: 'Workspaces & data', description: "Review each browser workspace, manage its policy, and copy or move selected website data between isolated profiles.", workspaces: 'Browser workspaces', workspacesDescription: 'Active and archived workspaces keep separate cookies and local storage.', createWorkspace: 'Create workspace', transferData: 'Copy or move data', manageWorkspace: 'Manage', workspaceActive: 'Active', workspaceArchived: 'Archived', workspaceTabs: '{count} tab | {count} tabs', workspaceSites: '{count} known website | {count} known websites', legacyHeading: 'Global history & legacy data', legacyDescription: 'Clear application-wide history or data retained by the legacy Default browser profile.', whatToClear: 'What to clear', history: 'History', localVisits: 'Local visits', cookies: 'Cookies & site data', signOut: 'May sign you out', cache: 'Cached files', slower: 'Reloads may be slower', clearingAll: 'Clearing all…', clearAll: 'Clear all legacy data… ({count})', totals: '{history} history page | {history} history pages', totalsDetail: '{history} · {cookies} · {cache} cache', loadingTotals: 'Loading legacy totals…', websites: 'Legacy websites', websitesDescription: "Search legacy Default-profile data and application-wide records, then clear selected categories for a website.", refresh: 'Refresh', search: 'Search legacy websites', range: '{shown} of {total}', finding: 'Finding legacy websites…', checking: "Checking legacy Default-profile data and application-wide records.", empty: 'No legacy websites', emptyDescription: 'Legacy entries appear when the Default profile retains cookies or cache, or when application-wide history and related records refer to a website.', noMatches: 'No matching websites', noMatchesDescription: 'Try a hostname, title, or full origin.', known: "Known to legacy profile", clearSiteAria: 'Clear selected legacy data for {origin}', clearing: 'Clearing…', clear: 'Clear…', exclusions: "Bookmarks ({bookmarks}), saved passwords ({passwords}), permissions ({permissions}), downloaded files, settings, and open tabs are preserved. Open pages are not reloaded. New MCP commands pause while clearing. Cookies, cache, and site data in this section belong to the legacy Default profile; history is application-wide. Chromium does not expose every storage-only origin. Related subdomains may share cookies." },
 ...
 kicker: 'Browser workspace', create: 'Create workspace', edit: 'Edit workspace', close: 'Close workspace editor', name: 'Workspace name', color: 'Color', siteAccess: 'Site access', siteAccessDescription: 'Optionally limit every top-level navigation in this workspace. Agents cannot change this policy.', unrestricted: 'Any safe website', unrestrictedDescription: 'Allow HTTP, HTTPS, and non-privileged browser documents.', restricted: 'Only listed sites', restrictedDescription: 'Block direct navigation, redirects, page links, forms, popups, and history entries outside this list.', allowedSites: 'Allowed site rules', allowedSitesPlaceholder: 'https://app.example\n*.trusted.example\nhttp://localhost:*', allowedSitesHelp: 'One rule per line. Use an exact HTTP(S) origin, *.example.com for subdomains, or a loopback port wildcard such as http://localhost:*.', blockedAttempts: 'Blocked navigation attempts ({count})', auditLoading: 'Loading the local navigation log…', auditError: 'The local navigation log could not be loaded.', auditEmpty: 'No navigation attempts have been blocked for this workspace.', startingData: 'Starting browser data', startingDescription: 'Start clean, or copy selected browser data from another workspace.', scratch: 'Start from scratch', scratchDescription: 'Use an empty isolated browser profile.', fork: 'Fork Default', forkDescription: 'Copy cookies and local storage without linking future changes.', websites: "Websites", clear: 'Clear', selectAll: 'Select all', noOrigins: 'No known website origins yet. Cookies from the selected source can still be copied.', defaultDescription: "This workspace owns a legacy browser profile. You can rename, archive, or delete it.", browserData: 'Browser data', browserDataDescription: 'Transfer selected browser data between workspaces without linking future changes.', transferDirection: 'Storage transfer direction', importDefault: 'Import from Default', saveDefault: 'Save to Default', loading: 'Loading known websites…', noSourceOrigins: 'No known website origins in the source profile. All cookies can still be copied.', copying: 'Copying…', creating: 'Creating workspace…', saving: 'Saving workspace…', closing: 'Closing workspace…', importSelected: 'Import selected data', saveSelected: 'Save selected data to Default', closePermanently: 'Close workspace permanently', closeDescription: 'Closes its tabs and deletes its isolated browser data.', unlockTitle: 'Unlock all tabs before closing a workspace', closeWorkspace: 'Close workspace', cancel: 'Cancel', save: 'Save changes' },
