export const enUS = {
  ...
  settings: {
    ...
    privacy: { heading: 'Privacy & browsing data', description: "Manage legacy browser profile data and application-wide history. Use workspace or page controls for individual workspace site data.", whatToClear: 'What to clear', history: 'History', localVisits: 'Local visits', cookies: 'Cookies & site data', signOut: 'May sign you out', cache: 'Cached files', slower: 'Reloads may be slower', clearingAll: 'Clearing all…', clearAll: 'Clear all websites… ({count})', totals: '{history} history page | {history} history pages', totalsDetail: '{history} · {cookies} · {cache} cache', loadingTotals: 'Loading profile totals…', websites: 'Websites', websitesDescription: "Search legacy profile data and application-wide records, then clear selected categories for a website.", refresh: 'Refresh', search: 'Search websites', range: '{shown} of {total}', finding: 'Finding websites…', checking: "Checking legacy profile data and application-wide records.", empty: 'No websites yet', emptyDescription: 'Websites appear after they are visited, opened, bookmarked, granted a permission, saved with an account, or store a cookie.', noMatches: 'No matching websites', noMatchesDescription: 'Try a hostname, title, or full origin.', known: "Known to legacy profile", clearSiteAria: 'Clear selected data for {origin}', clearing: 'Clearing…', clear: 'Clear…', exclusions: "Bookmarks ({bookmarks}), saved passwords ({passwords}), permissions ({permissions}), downloaded files, settings, and open tabs are preserved. Open pages are not reloaded. New MCP commands pause while clearing. Cookies, cache, and site data here belong to the legacy browser profile; history is application-wide. Manage individual workspace site data from workspace or page controls. Chromium does not expose every storage-only origin. Related subdomains may share cookies." },
