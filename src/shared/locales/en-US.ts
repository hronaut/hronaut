export const enUS = {
  workspaceLibrary: {
    ...
    archiveNotice: '“{name}” archived. Tabs and sign-ins are saved.', restoreNotice: '“{name}” restored.', clearNotice: '“{name}” cleared.', deleteNotice: '“{name}” deleted.',
    clearConfirm: 'Permanently clear “{name}”, close its pages, and delete its website data? This cannot be undone.', deleteConfirm: 'Permanently delete “{name}” and its website data? This cannot be undone.', actionError: 'Could not update this workspace. Please try again.',
  ...
  workspaceTemplates: {
    ...
    scope: "Templates contain only names, descriptions, colors, and selected start pages. They exclude cookies, local storage, passwords, tokens, workspace identities, site-access rules, and browser permissions.",
    privacy: "Names, descriptions, and URLs can still contain private information. Review every entry before saving or importing. Export starts with generic metadata and no pages.",
    newExport: "Prepare export",
    source: "Source platform: {platform}",
    entry: "Workspace {number}",
    pages: "Start pages \u2014 one HTTP(S) URL per line",
    add: "Add workspace",
    collisions: "Rename these entries before importing: {names}",
    importEffect: "Import creates new isolated profiles with direct agent access disabled and opens the listed pages. It does not copy sign-ins or merge existing profiles. Previewing a file creates no profiles and opens no pages.",
    review: "I reviewed the names and URLs, removed sensitive information, and approve this import or export.",
    import: "Import and open pages",
    imported: "The new workspaces were imported.",
    exported: "The reviewed template was saved.",
    partial: "Import did not finish. These new workspaces could not be removed; retry cleanup before another import.",
    rolledBack: "Import did not finish. All profiles created by this import were removed.",
    cleaned: "The remaining imported profiles were removed.",
    cleanup: "Retry cleanup",
    sourceWorkspace: "Optional source workspace",
    addSource: "Add source color as a new entry",
    chooseDetails: "These details are not included automatically. Selecting a name or page adds it to the last entry below.",
    includeName: "Include source name in last entry",
    includeDescription: "Include source description in last entry",
  ...
  appearance: {
    ...
    themes: {
      ...
      'cyberpunk-turbo': { label: 'Cyberpunk Turbo', description: 'Neon cyan, magenta and yellow' },
  ...
  settings: {
    ...
    mcp: { remote: { label: 'Allow connections from other computers', description: 'Listen on all IPv4 network interfaces. Token authentication is optional. Without it, anyone who can reach this listener can control your browser and attach local files.', restart: 'Restart Hronaut after changing remote access. Authentication changes apply immediately.', connection: 'On the other computer, use http://this-computer-LAN-IP:{port}/mcp and, if authentication is enabled, a bearer credential from Capability profiles below. Allow this port in your firewall. Use only a trusted network: HTTP does not encrypt traffic.' }, heading: 'MCP security', description: 'Control which applications can connect to this browser profile.', require: 'Require MCP authentication', requireDescription: 'Require the owner-only per-profile bearer token for MCP and health requests.', toolSet: 'MCP tool set', toolSetDescription: 'Choose the task-focused catalog for new MCP connections.', toolSetEssentials: 'Browser Essentials', toolSetQa: 'Web QA', toolSetComplete: 'Complete', toolSetReconnect: 'Connected MCP clients keep their current catalog. Reconnect them to apply this change.', port: 'MCP server port', portDescription: 'Move the local listener without restarting Hronaut. Connected clients must use the new endpoint.', moving: 'Moving…', applyPort: 'Apply port', tokenHelp: 'The compatibility token grants full access. Use a capability profile for restricted clients.', warning: 'Authentication is off. Anyone who can reach this listener can control logged-in tabs and attach local files, including other computers when remote access is active.', capabilities: { heading: 'Capability profiles', description: 'Create named credentials limited by browser tools, operation class, workspace, origin, exact arguments, expiry, and use count.', name: 'Profile name', preset: 'Access preset', presetReadOnly: 'Read only', presetEssentials: 'Browser Essentials', presetQa: 'Web QA', presetComplete: 'Complete', parent: 'Parent capability (optional)', parentRoot: 'Independent root capability', parentOption: '{name} · r{revision}', parentDescription: 'A derived credential must narrow its active parent. Parent expiry, rotation, revocation, and use limits also apply.', derivedFrom: 'Derived from {name} · parent revision {revision}', inactiveLineage: 'Inactive because its parent changed or exhausted its authority', workspaces: 'Workspace IDs (optional)', workspacesPlaceholder: 'One UUID per line; blank allows any owned workspace', origins: 'Website origins (optional)', originsPlaceholder: 'https://example.com — one origin per line', arguments: 'Exact argument constraints (optional)', argumentsPlaceholder: 'browser_click.ref=e12\nwallet_request.transaction.to=0x…', argumentsDescription: 'Use one tool.argument.path=value per line. Values are compared exactly and stored only as hashes.', argumentScope: 'Exact argument paths: {paths}', expiry: 'Expiry', oneHour: '1 hour', oneDay: '1 day', sevenDays: '7 days', noExpiry: 'No expiry', singleUse: 'Allow one tool call only', saving: 'Saving…', create: 'Create profile', credentialHeading: 'Copy this credential now', credentialWarning: 'Hronaut stores only its digest. This credential cannot be shown again.', copy: 'Copy credential', dismiss: 'Dismiss', profileSummary: 'Revision {revision} · {tools} tools · {uses} / {limit} uses', revoked: 'Revoked', expires: 'Expires {date}', rotate: 'Rotate', revoke: 'Revoke', inspect: 'Inspect scope', empty: 'No restricted capability profiles yet.', revokeConfirm: 'Revoke “{name}”? Connected clients will lose access immediately.' } },
    ...
    privacy: { heading: 'Workspaces & data', description: "Review each browser workspace, manage its policy, and copy or move selected website data between isolated profiles.", workspaces: 'Browser workspaces', workspacesDescription: 'Active and archived workspaces keep separate cookies and local storage.', createWorkspace: 'Create workspace', transferData: 'Copy or move data', manageWorkspace: 'Manage', workspaceActive: 'Active', workspaceArchived: 'Archived', workspaceTabs: '{count} tab | {count} tabs', workspaceSites: '{count} known website | {count} known websites', historyHeading: "Global history", historyDescription: "Clear application-wide browsing history. Manage website storage in its workspace.", whatToClear: 'What to clear', history: 'History', localVisits: 'Local visits', cookies: 'Cookies & site data', signOut: 'May sign you out', cache: 'Cached files', slower: 'Reloads may be slower', clearingAll: 'Clearing all…', clearAll: "Clear history… ({count})", totals: '{history} history page | {history} history pages', totalsDetail: '{history} · {cookies} · {cache} cache', loadingTotals: "Loading history totals…", websites: "Visited websites", websitesDescription: "Search browsing history and application-wide website records.", refresh: 'Refresh', search: "Search websites", range: '{shown} of {total}', finding: "Finding websites…", checking: "Checking browsing history and application-wide records.", empty: "No websites yet", emptyDescription: "Websites appear when history or related application records refer to them.", noMatches: 'No matching websites', noMatchesDescription: 'Try a hostname, title, or full origin.', known: "Known website", clearSiteAria: "Clear history for {origin}", clearing: 'Clearing…', clear: 'Clear…', exclusions: "Bookmarks ({bookmarks}), saved passwords ({passwords}), permissions ({permissions}), downloads, settings, open tabs, and workspace website data are preserved." },
    support: { trialNotStarted: "Your 10-day trial starts with the first agent tool call.", trialActive: "Trial ends {time}.", trialExpired: "Your trial has ended. Subscribe to continue agent automation.", kicker: 'License', thanks: 'Thank you for licensing Hronaut', heading: "Activate Hronaut", description: "All users need a subscription after a 10-day trial. $4/month or $24/year per user (50% off $48).", active: 'License {key} is active on this device.', activations: '{used} of {limit} device activations used.', unlimited: 'unlimited', lastChecked: 'Last checked {time}.', checking: 'Checking…', check: 'Check license', manage: 'Manage subscription ↗', deactivating: 'Deactivating…', deactivate: 'Deactivate device', activateDescription: 'Activate the license key from your Creem receipt.', secure: 'The key is encrypted with your operating system secure storage and is used only for Creem license validation.', unavailable: 'License activation requires an operating-system secure storage backend.', key: 'License key', placeholder: 'XXXX-XXXX-XXXX-XXXX', activating: 'Activating…', activate: 'Activate license', support: 'Buy license ↗', alternatives: 'License and community', license: "Hronaut License ↗", contributing: 'Contributing guide ↗', issue: 'Report an issue ↗' }
  },
  wallets: {
    settingsTabs: "Wallet settings",
    accessTab: "Access & automation",
    activityTab: "Activity",
    walletListDescription: "Select a wallet to view its details or make changes.",
    manageAccess: "Manage access",
    accessDescription: "Choose a wallet to manage workspace access, signing rules, and website permissions.",
    accessEmptyDescription: "Add a wallet before configuring access and automation.",
    noPolicies: "No automation policies configured for this wallet.",
    noPermissions: "No website permissions granted for this wallet.",
    noActivity: "No wallet activity yet",
    activityDescription: "Recent wallet events will appear here.",
    kinds: {
      "managed": "Signing wallet",
      "agent": "Agent wallet",
      "watch-only": "Watch only",
    },
    heading: 'Wallets',
    description: 'Manage local EVM, Solana, and Tron wallets and control how websites and agents can use them.',
    ...
    noWalletsConfiguredDescription: 'Add a wallet to generate a new account, import an existing one, or watch a public address.',
  ...
  workspaceEditor: {
    transferData: "Transfer browser data",
    archived: "Archived",
    archiveBeforeMove: "Archive both workspaces before moving data so their pages cannot change it during the move. Copy works while workspaces are open.",

    reloadOrigins: "Reload source websites",
    agentAccess: "Allow direct agent access",
    agentAccessDescription: "When disabled, agents cannot directly use or change this workspace.",
    agentForkAllowed: "Agents can still fork this workspace into an independent copy.",
    forkWorkspace: "Fork a workspace",
    sourceWorkspace: "Source workspace",
    targetWorkspace: "Destination workspace",
    chooseWorkspace: "Choose a workspace",
    forkBlankTab: "The new workspace opens a blank tab. Existing tabs are not copied.",
    transferMode: "Transfer mode",
    copy: "Copy",
    move: "Move",
    copyDescription: "Keep the source data and copy it to the destination.",
    moveDescription: "Copy to the destination, then remove the transferred data from the source. This may sign you out in the source workspace.",
    overwriteDescription: "Only cookies and local storage are transferred. Matching destination cookies and storage keys are overwritten; other destination data stays.",
    copySelected: "Copy selected data",
    moveSelected: "Move selected data",
    moving: "Moving…",
    moveConfirm: "Move selected cookies and local storage from {source} to {target}? Matching destination data will be overwritten, and transferred source data will be removed.",
    moved: "Moved {cookies} cookies and {items} local storage items.",
    moveIncomplete: "Data was copied, but some source data could not be removed. The move is incomplete.",
    partitionedCookiesOmitted: "Skipped {count} partitioned cookies because their partition keys cannot be recreated safely. The transfer is incomplete.",
 kicker: 'Browser workspace', create: 'Create workspace', edit: 'Edit workspace', close: 'Close workspace editor', name: 'Workspace name', description: 'Description', descriptionPlaceholder: 'Purpose, current work, and useful browser state', descriptionHelp: 'Stored locally with this workspace and shown to agents when they list or resume it.', color: 'Color', siteAccess: 'Site access', siteAccessDescription: 'Optionally limit every top-level navigation in this workspace. Agents cannot change this policy.', unrestricted: 'Any safe website', unrestrictedDescription: 'Allow HTTP, HTTPS, and non-privileged browser documents.', restricted: 'Only listed sites', restrictedDescription: 'Block direct navigation, redirects, page links, forms, popups, and history entries outside this list.', allowedSites: 'Allowed site rules', allowedSitesPlaceholder: 'https://app.example\n*.trusted.example\nhttp://localhost:*', allowedSitesHelp: 'One rule per line. Use an exact HTTP(S) origin, *.example.com for subdomains, or a loopback port wildcard such as http://localhost:*.', blockedAttempts: 'Blocked navigation attempts ({count})', auditLoading: 'Loading the local navigation log…', auditError: 'The local navigation log could not be loaded.', auditEmpty: 'No navigation attempts have been blocked for this workspace.', startingData: 'Starting browser data', startingDescription: 'Start clean, or copy selected browser data from another workspace.', scratch: 'Start from scratch', scratchDescription: 'Use an empty isolated browser profile.', forkDescription: 'Copy cookies and local storage without linking future changes.', websites: "Websites", clear: 'Clear', selectAll: 'Select all', noOrigins: 'No known website origins yet. Cookies from the selected source can still be copied.', browserData: 'Browser data', browserDataDescription: 'Transfer selected browser data between workspaces without linking future changes.', loading: 'Loading known websites…', noSourceOrigins: 'No known website origins in the source profile. All cookies can still be copied.', copying: 'Copying…', creating: 'Creating workspace…', saving: 'Saving workspace…', closing: 'Closing workspace…', importSelected: 'Import selected data', closePermanently: 'Close workspace permanently', closeDescription: 'Closes its tabs and deletes its isolated browser data.', unlockTitle: 'Unlock all tabs before closing a workspace', closeWorkspace: 'Close workspace', cancel: 'Cancel', save: 'Save changes' },
  ...
  commandCatalog: {
    ...
    commands: {
      home: { label: 'Open Hronaut Home', description: 'Show the application dashboard' }, 'new-tab': { label: 'New tab', description: "Open a blank tab in the current workspace" }, 'search-tabs': { label: 'Search tabs', description: 'Find open, saved, and recently closed websites' }, downloads: { label: 'Show downloads', description: 'Review current and completed downloads' }, bookmarks: { label: 'Show bookmarks', description: 'Open locally saved pages' }, history: { label: 'Show browsing history', description: 'Search locally visited pages' }, find: { label: 'Find in page', description: 'Search text in the current website' }, reload: { label: 'Reload page', description: 'Reload the current website' }, 'reload-ignoring-cache': { label: 'Reload without cache', description: 'Fetch the current website again from the network' },
  ...
  runtime: {
    ...
    mcp: { settling: "Agents paused · {count} settling", pauseGuidance: "New commands are blocked and workspace write leases are revoked. Pause does not undo actions already dispatched. Inspect the visible page, resume agents, then claim fresh write ownership before continuing.", copied: 'MCP URL copied', starting: 'MCP starting', paused: 'Agents paused', error: 'MCP error', ready: 'MCP ready', failed: 'MCP failed: {error}', startingAt: 'MCP is starting at {url}', title: 'MCP: {url}', unknown: 'Unknown startup error', resumeCommands: "Inspect the visible page and obtain a fresh snapshot before resuming; writers must claim workspace ownership again", pauseCommands: 'Pause new MCP commands and revoke workspace write leases', unavailable: 'MCP server is unavailable', resumeAgents: 'Resume agents', pauseAgents: 'Pause agents' },
    ...
    locks: { websiteOnly: 'Tab lock is available on websites', allLocked: 'Human page input is blocked; trusted Hronaut controls and agents keep working', unlockTab: 'Unlock page input in this tab', lockTab: 'Lock page input in this tab', unlockAll: 'Allow human page input in all website tabs. Focus protection stays automatic.', lockAll: 'Block human page input in all website tabs; trusted Hronaut controls and agents keep working. Focus protection stays automatic.', closeShortcut: 'Close tab (Ctrl/Cmd+W)', inputLocked: 'Page input is locked', inputLock: 'Page input lock' },
    pageLifecycle: { active: 'Live', frozen: 'Frozen', unknownShort: 'Unknown', freeze: 'Freeze this live page for deterministic review', resume: 'Resume this frozen page', unknown: 'Page hold outcome is unknown; reload or navigate to establish a fresh active document' },
    ...
    license: { enterKey: 'Enter the license key from your Creem receipt.' },
  ...
  runtimeActions: {
    ...
    mcp: { disableConfirm: 'Disable MCP authentication? Anyone who can reach the listener, including other computers when remote access is active, will be able to control your logged-in browser and attach local files.', invalidPort: 'Choose a whole number from {min} through {max}.', moving: 'Moving the MCP listener to port {port}…', active: 'MCP port {port} is active.', endpoint: 'Active endpoint: {url}' },
    ...
    browsingData: { confirm: "Clear browsing history for all websites?\n\n{items}\n\nWorkspace website data and other application records will remain.", item: '• {item}', websiteConfirm: 'Clear {items} for {origin}? Open pages will not reload automatically.', cookieMeta: '{count} cookie | {count} cookies', historyMeta: '{count} history page | {count} history pages', bookmarkMeta: '{count} bookmark | {count} bookmarks', passwordMeta: '{count} saved account | {count} saved accounts', permissionMeta: '{count} permission decision | {count} permission decisions', clearedSite: 'Selected data was cleared for {origin}. Reload open pages when you are ready. | Selected data were cleared for {origin}. Reload open pages when you are ready.' },
  ...
  shell: {
    ...
    tabs: { resizeRail: "Resize workspace panel", resizeRailHelp: "Drag to resize. Arrow keys adjust width; Home/End use the minimum/maximum. Double-click to reset.",
      navigation: 'Tab navigation', list: 'Browser tabs and workspaces', scrollBack: 'Show previous tabs', scrollForward: 'Show more tabs', pageAttention: 'Page needs attention', agentAttention: 'Agent needs your attention', sleeping: 'Sleeping to save resources', frozen: 'Page frozen for review', freezeUnknown: 'Page hold outcome unknown', stackedVisible: 'Visible in stacked split view', sideVisible: 'Visible in side-by-side split view', inputLocked: 'Page input locked',
  ...
  accessibilityAudit: {
    kicker: 'Local WCAG check', heading: 'Accessibility', close: 'Close accessibility audit', checking: 'Checking the rendered page…', privacy: 'The audit runs locally and does not send page data to a service.', failed: 'Audit could not finish', violation: 'violation', violations: 'violations', critical: 'critical', serious: 'serious', review: 'review', clear: 'No automated WCAG A/AA violations found', manual: 'Manual keyboard and assistive-technology testing is still needed.', element: 'element', elements: 'elements', guidance: 'Rule guidance ↗', runAgain: 'Run again', baseline: 'Accessibility baseline', comparedWith: 'Compared with {time}', unknown: 'Unknown', newFindings: 'New findings', remainingFindings: 'Remaining findings', resolvedFindings: 'Resolved findings', notComparable: 'Unavailable because the audit scope, engine, or result coverage changed.', noFindings: 'None', measureAfter: 'Run the audit again after your change to compare rule and target fingerprints.', clearBaseline: 'Clear baseline', replaceBaseline: 'Replace baseline', saveBaseline: 'Save baseline'
  },
  performance: {
  ...
  repro: { selectorUnavailable: 'No unique selector; recreate this step manually.', kicker: 'Privacy-safe timeline', heading: 'Repro recorder', close: 'Close repro recorder', loading: 'Loading reproduction steps…', failed: 'Repro recorder needs attention', tryAgain: 'Try again', recording: 'Recording accepted human actions', stopped: 'Recording stopped', ready: 'Ready to record', privacy: 'Typed values, clipboard contents, uploads, screenshots, and page HTML are never recorded.', showIssue: 'Show the issue once', emptyDescription: 'Start recording, reproduce the problem in this tab, then stop and copy a compact timeline into agent chat.', start: 'Start recording', timelineAria: 'Recorded reproduction steps', selectedStepAria: 'Selected reproduction step', selectedStep: 'Step {index}', action: 'Action', target: 'Target', selector: 'Selector', key: 'Key', position: 'Position', page: 'Page', valueRedacted: 'The typed value was not recorded.', truncated: 'Timeline reached its 200-step limit.', privacyScope: 'Privacy and scope', stepCount: '{count} step | {count} steps', review: '· review before sharing', clear: 'Clear', stop: 'Stop', recordAgain: 'Record again', copied: 'Copied', copyTimeline: 'Copy timeline', copiedPlaywright: 'Copied Playwright', copyPlaywright: 'Copy Playwright', toolRecording: 'Recording · {steps}', toolReady: '{steps} ready to share', toolDescription: 'Record safe steps for an agent', toolAria: 'Repro recorder: {status}', caveats: { values: 'Typed values, clipboard contents, uploaded file paths, screenshots, and page HTML are never recorded.', selectors: 'Selectors use only structural tag positions and can require adjustment after the page changes.', scope: 'The recorder captures accepted human input and top-level navigation in this tab; MCP tool actions are not duplicated in the timeline.', bounded: 'The timeline keeps at most 200 steps in memory and is discarded when the tab or Hronaut closes.' } },
  ...
  downloads: {
    ...
    paused: 'Paused',
    kicker: 'Browser files', heading: 'Downloads', clearFinished: 'Clear finished', close: 'Close downloads', empty: 'No downloads yet', emptyDescription: 'Files you download will appear here.', downloading: 'Downloading {filename}', cancelAria: 'Cancel {filename}', cancel: 'Cancel download', showAria: 'Show {filename} in folder', show: 'Show in folder', received: '{received} of {total}', downloaded: '{received} downloaded', complete: '{size} · Complete', cancelled: 'Cancelled', interrupted: 'Interrupted' },
  ...
  home: {
    ...
    journey: {
      ...
      verify: 'Verify',
      tryTask: 'Try a task',
      searchAgents: 'Search coding agents',
      noAgents: 'No matching agents. Try another name.',
      retry: 'Retry',
      setup: 'Setup & connection',
      toggleSetup: 'Show or hide setup',
      waiting: 'Waiting for your agent',
      observed: 'A client has been seen. Try the task below to verify browser access.',
      unavailable: 'Status is unavailable. Last known activity is shown below.',
      browseTools: 'Browse available tools',
      searchTools: 'Search tools',
      noTools: 'No matching tools. Try another name.',
    },
    title: 'Hronaut Home',
    brand: 'Hronaut home',
    ...
    security: {
      disabled: 'Warning: MCP authentication is disabled for this launch. Anyone who can reach the listener can control this browser profile.',
    ...
    firstRun: {
      ...
      description: "After connecting, copy this prompt into your coding agent. You will see it create an isolated workspace and inspect a page.",
      prompt: "Using Hronaut, create a new isolated workspace named “Hronaut first run”, open https://example.com, take a semantic snapshot, and tell me the page heading. Use only this workspace.",
      copy: 'Copy prompt'
    },
    activity: {
  ...
  native: {
    ...
    errors: { clipboard: 'The system clipboard did not accept the text.', tabUnavailable: 'The tab is no longer available.', actionFailed: 'The requested browser action could not be completed.', screenshotCreate: 'Could not create the selected screenshot', linuxSecrets: 'No protected Linux secret store is available. Hronaut will not save passwords with basic-text encryption.', secureStorage: 'The operating system secure storage is unavailable.', passwordImportRead: 'Could not read the selected password file.', passwordImportTooLarge: 'The password file is larger than the 10 MB import limit.', passwordImportInvalid: 'The selected file is not a valid UTF-8 CSV password export.', passwordImportColumns: 'The CSV must contain url, username, and password columns.', passwordImportRows: 'The CSV contains more than 3,000 password rows. Split it into smaller files and try again.', passwordImportEmpty: 'No valid HTTP or HTTPS passwords were found in the selected CSV.', activationLimit: 'This license has reached its device activation limit.', subscriptionInactive: 'The commercial subscription for this license is not active.', entitlementPending: 'This purchase is still being synchronized. Try again in a moment.', instanceConflict: 'This device activation is no longer available.', licenseInactive: 'This license is no longer active.', licenseNotFound: 'The license was not found.', invalidLicense: 'The license could not be validated.', invalidLicenseKey: 'Enter the complete license key from your Creem receipt.', providerUnavailable: 'The license service is temporarily unavailable.', providerInvalid: 'The license service returned an invalid response.', wrongProduct: 'This license is not for Hronaut.' },
    dialog: {
