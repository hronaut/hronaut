export const enUS = {
 ...
 kicker: 'Browser workspace', create: 'Create workspace', edit: 'Edit workspace', close: 'Close workspace editor', name: 'Workspace name', description: 'Description', descriptionPlaceholder: 'Purpose, current work, and useful browser state', descriptionHelp: 'Stored locally with this workspace and shown to agents when they list or resume it.', color: 'Color', siteAccess: 'Site access', siteAccessDescription: 'Optionally limit every top-level navigation in this workspace. Agents cannot change this policy.', unrestricted: 'Any safe website', unrestrictedDescription: 'Allow HTTP, HTTPS, and non-privileged browser documents.', restricted: 'Only listed sites', restrictedDescription: 'Block direct navigation, redirects, page links, forms, popups, and history entries outside this list.', allowedSites: 'Allowed site rules', allowedSitesPlaceholder: 'https://app.example\n*.trusted.example\nhttp://localhost:*', allowedSitesHelp: 'One rule per line. Use an exact HTTP(S) origin, *.example.com for subdomains, or a loopback port wildcard such as http://localhost:*.', blockedAttempts: 'Blocked navigation attempts ({count})', auditLoading: 'Loading the local navigation log…', auditError: 'The local navigation log could not be loaded.', auditEmpty: 'No navigation attempts have been blocked for this workspace.', startingData: 'Starting browser data', startingDescription: 'Start clean, or copy selected browser data from another workspace.', scratch: 'Start from scratch', scratchDescription: 'Use an empty isolated browser profile.', forkDescription: 'Copy cookies and local storage without linking future changes.', websites: "Websites", clear: 'Clear', selectAll: 'Select all', noOrigins: 'No known website origins yet. Cookies from the selected source can still be copied.', browserData: 'Browser data', browserDataDescription: 'Transfer selected browser data between workspaces without linking future changes.', loading: 'Loading known websites…', noSourceOrigins: 'No known website origins in the source profile. All cookies can still be copied.', copying: 'Copying…', creating: 'Creating workspace…', saving: 'Saving workspace…', closing: 'Closing workspace…', importSelected: 'Import selected data', closePermanently: 'Close workspace permanently', closeDescription: 'Closes its tabs and deletes its isolated browser data.', unlockTitle: 'Unlock all tabs before closing a workspace', closeWorkspace: 'Close workspace', cancel: 'Cancel', save: 'Save changes' },
  ...
  runtime: {
    ...
    mcp: { settling: "Agents paused · {count} settling", pauseGuidance: "New commands are blocked. Pause does not undo actions already dispatched. Inspect the visible page and obtain a fresh snapshot before continuing.", copied: 'MCP URL copied', starting: 'MCP starting', paused: 'Agents paused', error: 'MCP error', ready: 'MCP ready', failed: 'MCP failed: {error}', startingAt: 'MCP is starting at {url}', title: 'MCP: {url}', unknown: 'Unknown startup error', resumeCommands: "Inspect the visible page and obtain a fresh snapshot before resuming new MCP commands", pauseCommands: 'Pause new MCP commands', unavailable: 'MCP server is unavailable', resumeAgents: 'Resume agents', pauseAgents: 'Pause agents' },
