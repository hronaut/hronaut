export const enUS = {
  ...
  home: {
    ...
    connect: {
      ...
      guides: {
        ...
        zooCode: 'Adds Hronaut to the maintained Zoo Code community successor with tool auto-approval disabled.',
  ...
  native: {
    ...
    dialog: {
      closeTabTitle: 'Close this tab?', closeTabMessage: 'This page asked Hronaut to confirm before closing.', closeTabDetail: 'Closing the tab may discard changes that have not been saved.', keepEditing: 'Keep editing', discardChanges: 'Discard changes',
